...
OFFER = {
    "reminder_after_10": {
        "ru": (
            ...
            "Осталось 5 в пробном периоде. Премиум снимает ограничение — оформить на 30 дней можно за 1000 ⭐ через /buy."
        ),
        "en": (
            "You’re on fire — 🛫 that’s 10 messages today!\n"
            "You’ve got 5 left on the trial. Go Premium (30 days for 1000 ⭐) via /buy."
        ),
    },
    "limit_reached": {
        "ru": (
            "Ты сегодня сделал(а) 15 сообщений — лимит пробного дня достигнут.\n"
            "Хочешь без ограничений? 30 дней Премиум за 1000 ⭐ — /buy\n"
            "Хочешь поддержать проект — /donate 🙌"
        ),
        "en": (
            "You’ve hit today’s 15-message limit.\n"
            "Go Premium for 30 days (1000 ⭐) — /buy\n"
