...
PREPARING_MESSAGE = {
    "ru": "⌨️ Немного подождите, идёт подготовка…",
    "en": "⌨️ Please wait a moment, preparing everything for you…"
}

START_MESSAGE = {
    'ru': (
        "👋 Привет! Добро пожаловать в Talktome — пространство, где учить языки легко и интересно.\n\n"
...
INTRO_QUESTIONS = {
    ...
    'ru': [
        "Если бы ты мог(ла) выбрать любую суперсилу, что бы это было и почему?",
        "Как бы выглядел твой идеальный выходной?",
        "Если бы ты мог(ла) отправиться в любую точку мира, куда бы ты поехал(а)?",
        "Чему новому ты хочешь научиться в этом году?",
        "Что самого интересного ты читал(а) или смотрел(а) недавно?"
    ]
}
